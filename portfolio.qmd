...
### Ecommerce & Payment Platform Fraud Analytics Workflow

[View the analysis (Quarto Site Link)](https://bmdknndy.github.io/TransactionFraudRiskAnalytics/)

-   Uses R & SQL to show how payment platforms and ecommerce businesses can use transaction-level data to balance approval rates and loss exposure when dealing with disputed transactions.
